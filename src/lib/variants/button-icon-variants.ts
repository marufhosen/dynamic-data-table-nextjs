  ...
  "cursor-pointer relative inline-flex items-center justify-center gap-1 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300",
  {
    variants: {
      ...
      shadow: {
        ...
        danger: "hover:enabled:shadow-xl hover:enabled:shadow-danger-500/50 dark:hover:enabled:shadow-danger-800/20",
      }
    },
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        variant: "outlined",
        className:
          "[&>span>.loader]:text-muted-500 dark:[&>span>.loader]:text-muted-200 border border-muted-300 dark:border-muted-700 text-muted-500 hover:bg-white hover:enabled:bg-muted-100 dark:hover:enabled:bg-muted-950 active:enabled:bg-muted-50 dark:active:enabled:bg-muted-900 hover:enabled:text-muted-600 dark:hover:enabled:text-muted-100",
      },
      {
        color: "muted",
        variant: "outlined",
